...
# setwd("D:/MODIS_AOD/new_https_data")
...
dir.create(as.character(folder_day))
setwd(paste0(wd,"/",folder_year,"/", folder_day))


# files TERRA (from 06:00 am to 08:00 am)

for (i in formatC(seq(0, 55, 5), width=2, flag=0)){
  tryCatch({
  time_06 <- paste0("06",i)
  print(time_06)
  file_06 = paste0("https://karafede:Password08@nrt3.modaps.eosdis.nasa.gov/allData/61/MOD04_L2/",folder_year,"/",folder_day,"/MOD04_L2.A2018",folder_day,".",time_06,".061.NRT.hdf")
  mapply(download.file, file_06,basename(file_06))
  }, error= function(err) { print(paste0("No TERRA data"))
  ...
  tryCatch({
    time_07 <- paste0("07",i)
    print(time_07)
    file_07 = paste0("https://karafede:Password08@nrt3.modaps.eosdis.nasa.gov/allData/61/MOD04_L2/",folder_year,"/",folder_day,"/MOD04_L2.A2018",folder_day,".",time_07,".061.NRT.hdf")
    mapply(download.file, file_07,basename(file_07))
  }, error= function(err) { print(paste0("No TERRA data"))
...
# files AQUA (from 09:00 am to 10:00 am)

for (i in formatC(seq(0, 55, 5), width=2, flag=0)){
  tryCatch({
    time_09 <- paste0("09",i)
    print(time_09)
    file_09 = paste0("https://karafede:Password08@nrt3.modaps.eosdis.nasa.gov/allData/61/MYD04_L2/",folder_year,"/",folder_day,"/MYD04_L2.A2018",folder_day,".",time_09,".061.NRT.hdf")
    mapply(download.file, file_09,basename(file_09))
  }, error= function(err) { print(paste0("No AQUA data"))
  ...
  tryCatch({
    time_10 <- paste0("10",i)
    print(time_10)
    file_10 = paste0("https://karafede:Password08@nrt3.modaps.eosdis.nasa.gov/allData/61/MYD04_L2/",folder_year,"/",folder_day,"/MYD04_L2.A2018",folder_day,".",time_10,".061.NRT.hdf")
    mapply(download.file, file_10,basename(file_10))
  }, error= function(err) { print(paste0("No AQUA data"))
...
extract_HDF <- function (file) {      ## this is the filenames 
  ...
  system(paste0('gdal_translate ', get_subdatasets(file)[64],' AOD.tif'))
  ...
  system(paste0('gdal_translate ', get_subdatasets(file)[71],' lon.tif'))
  ...
  system(paste0('gdal_translate ', get_subdatasets(file)[72],' lat.tif'))
...
PM25_2015_GRW <- raster("/home/mariners/MODIS_AOD/GlobalGWR_PM25_GL_201501_201512-RH35.nc")
