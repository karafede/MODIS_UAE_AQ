...
# Terra
url_Terra = paste("ftp://karafede:Password08@nrt3.modaps.eosdis.nasa.gov/allData/61/MOD04_L2/",folder_year,"/",folder_day, "/", sep = "")
# Aqua
url_Aqua = paste("ftp://karafede:Password08@nrt3.modaps.eosdis.nasa.gov/allData/61/MYD04_L2/",folder_year,"/",folder_day, "/", sep = "")
...
tryCatch({
Overpass_times_Terra <- read.csv(paste0("/home/mariners/MODIS_AOD/Overpass_times_Terra_",
                                        current_date,".csv"))
...
tryCatch({
Overpass_times_Aqua <- read.csv(paste0("/home/mariners/MODIS_AOD/Overpass_times_Aqua_",
                                       current_date,".csv"))
